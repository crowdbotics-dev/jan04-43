"""
Django settings for jan04_43 project.
...
WSGI_APPLICATION = 'jan04_43.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "jan04_43 API",
    "DESCRIPTION": "API documentation for jan04_43 App",
    "VERSION": "v1",
}
